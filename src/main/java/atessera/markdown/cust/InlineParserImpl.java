...
public final class InlineParserImpl implements InlineParser, InlineParserState {
    ...
    public InlineParserImpl(InlineParserContext context, boolean allowHtmlInline)
    {
        this.context = context;
        this.inlineContentParserFactories = calculateInlineContentParserFactories(context.getCustomInlineContentParserFactories(), allowHtmlInline);
    ...
    private List<InlineContentParserFactory> calculateInlineContentParserFactories(List<InlineContentParserFactory> customFactories, boolean allowHtmlInline)
    {
    ...
    @Override public Scanner scanner()
    {
        return scanner;
    }

    @Override public void parse(SourceLines lines, Node block)
    {
        reset(lines);
        while (true)
	{
